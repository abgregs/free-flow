...
The `make install` step requires a one-time self-signed code-signing certificate named "Free Flow Dev" in the login keychain. See [docs/architecture/distribution.md](docs/architecture/distribution.md).
